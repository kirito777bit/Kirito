...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY KAELSWORD🤍*",
...
BOT_NAME: process.env.BOT_NAME || "KAELSWORD",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "237653845041",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "kirito",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ KAELSWORD*",
// bot description    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/nzc6xk.jpg",
// image for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> *KAELSWORD*⚡",
// alive msg content
...
DEV: process.env.DEV || "237653845041",
